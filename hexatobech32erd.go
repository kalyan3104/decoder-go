...
func main() {
	hexString := "000000000000000000010000000000000000000000000000000000000002ffff"
	...
	bech32Address, err := bech32.Encode("erd", convertedData)
	if err != nil {
		log.Fatalf("Failed to encode Bech32 address: %v", err)
	}

	fmt.Println("Bech32 Address with HRP 'erd':", bech32Address)
}
